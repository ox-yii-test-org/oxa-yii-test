...
class MaleController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Male');
	...
	{
		$model=new Male('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Male']))
			$model->attributes=$_GET['Male'];
	 ...
	 * @return Male the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Male::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Male $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='male-form')
		{
